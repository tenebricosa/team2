    ...
    render: function() {
        return (
            <ul className="tabs" role="tablist">
                ...
                <li className="tabs__item"><a href="#full" data-toggle="tab" className="tabs__link" role="tab" aria-controls="full" aria-expanded="true" >Подробно</a></li>
                ...
                <li className="tabs__item active"><a href="#mapTab" data-toggle="tab" className="tabs__link tabs__item_active" role="tab" aria-controls="mapTab" aria-expanded="true">На карте</a></li>
            </ul>
        );
    }
});
